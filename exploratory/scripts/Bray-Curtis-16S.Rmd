...
combo_list <- list(
  combo.55v1  = combo.55v1,
  combo.55v2  = combo.55v2,
  combo.102v1 = combo.102v1,
  combo.102v2 = combo.102v2,
  combo.68v1  = combo.68v1,
  combo.68v2  = combo.68v2,
  combo.79v1  = combo.79v1,
  combo.79v2  = combo.79v2,
  combo.85v1  = combo.85v1,
  combo.85v2  = combo.85v2,
  combo.84v1  = combo.84v1,
  combo.84v2  = combo.84v2
)
...
plots <- imap(combo_list, ~{
  .x %>%
    ...
    ggplot(aes(x = timepoint, y = distance, color = timepoint)) +
